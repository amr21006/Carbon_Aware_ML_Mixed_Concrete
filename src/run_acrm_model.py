...
OUT_RESULTS = RESULTS_DIR / "acrm_single_model_results.csv"
OUT_OPERATIONAL = RESULTS_DIR / "acrm_single_model_operational_metrics.csv"
OUT_PREDICTIONS = RESULTS_DIR / "acrm_single_model_predictions.csv"
OUT_COMPARISON = RESULTS_DIR / "acrm_single_model_vs_leaders.csv"
OUT_MANIFEST = RESULTS_DIR / "acrm_single_model_manifest.json"
...
def compare_to_leaders(results: pd.DataFrame, operational: pd.DataFrame) -> pd.DataFrame:
    ...
    metrics_path = RESULTS_DIR / "final_all_algorithm_metrics_with_new_variants.csv"
    op_path = RESULTS_DIR / "operational_metrics_all_models.csv"
