...
OUTPUT_RESULTS = RESULTS_DIR / "validation_results.csv"
OUTPUT_PREDICTIONS = RESULTS_DIR / "validation_predictions.csv"
OUTPUT_BOOTSTRAP = RESULTS_DIR / "paired_bootstrap.csv"
OUTPUT_SUMMARY = RESULTS_DIR / "main_dataset_summary.csv"
OUTPUT_MANIFEST = RESULTS_DIR / "validation_manifest.json"
