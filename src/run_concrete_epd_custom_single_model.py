...
OUT_RESULTS = RESULTS_DIR / "custom_single_model_results.csv"
OUT_SELECTION = RESULTS_DIR / "custom_single_model_selection.csv"
OUT_COMPARISON = RESULTS_DIR / "custom_vs_sota.csv"
OUT_MANIFEST = RESULTS_DIR / "custom_single_model_manifest.json"
OUT_FIXED_RESULTS = RESULTS_DIR / "carm_boost_fixed_results.csv"
OUT_FIXED_COMPARISON = RESULTS_DIR / "carm_boost_fixed_vs_sota.csv"
OUT_FIXED_MANIFEST = RESULTS_DIR / "carm_boost_fixed_manifest.json"
...
def compare_to_sota(results: pd.DataFrame) -> pd.DataFrame:
    benchmark = pd.read_csv(RESULTS_DIR / "algorithm_benchmark_summary.csv")
    sota_rows = []
