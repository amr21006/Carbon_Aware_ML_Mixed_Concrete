...
from concrete_epd_pipeline import MAIN_QUANTILE, RESULTS_DIR, load_and_prepare, make_splits, make_target
...
OUT_RESULTS = RESULTS_DIR / "p20_ranker_results.csv"
OUT_MANIFEST = RESULTS_DIR / "p20_ranker_manifest.json"
