...
from run_concrete_epd_model import MAIN_QUANTILE, RESULTS_DIR, load_and_prepare, make_target


ROOT = Path(__file__).resolve().parents[1]
V5_CSV = ROOT / "data" / "raw" / "concrete_epd_mendeley_v5.csv"
PREDICTIONS = RESULTS_DIR / "concrete_epd_v5_domain_lgbm_predictions.csv"
DEFAULT_SCORE_COLUMN = "domain_lgbm_probability"
OUT_DETAILS = RESULTS_DIR / "concrete_epd_v5_procurement_opportunity_details.csv"
OUT_SUMMARY = RESULTS_DIR / "concrete_epd_v5_procurement_opportunity_summary.csv"
OUT_BY_GROUP = RESULTS_DIR / "concrete_epd_v5_procurement_opportunity_by_group.csv"
OUT_MANIFEST = RESULTS_DIR / "concrete_epd_v5_procurement_opportunity_manifest.json"
