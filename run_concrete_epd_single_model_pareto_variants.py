...
OUT_VARIANTS = RESULTS_DIR / "concrete_epd_v5_single_model_pareto_variants.csv"
OUT_COMPARISON = RESULTS_DIR / "concrete_epd_v5_single_model_pareto_vs_metric_leaders.csv"
OUT_MANIFEST = RESULTS_DIR / "concrete_epd_v5_single_model_pareto_manifest.json"
...
def compare_to_metric_leaders(results: pd.DataFrame) -> pd.DataFrame:
    benchmark_path = RESULTS_DIR / "concrete_epd_v5_final_all_algorithm_metrics.csv"
